...
// ==================================================================
const GEMINI_API_KEY = 'AQ.Ab8RN6LUst-X3iJOPtbDfhNv35a4zIFlfcv9zRdn0pYqyS6eSA';
// ==================================================================

// We will store the official SDK model here once initialized
let aiModel = null; 
...
const isApiKeyAvailable = () => GEMINI_API_KEY && GEMINI_API_KEY !== 'YOUR_GEMINI_API_KEY_HERE' && GEMINI_API_KEY !== 'YOUR_NEW_API_KEY_HERE' && GEMINI_API_KEY.length > 10;
...
// USING THE OFFICIAL SDK FOR JSON GENERATION
            ...
            <div class="detail-section">
                ...
                <div class="booking-options-container">
                    ...
                    <div class="booking-platforms-box">
                        ...
                        <p>Find tickets, guided tours, and combo deals on these popular platforms.</p>
...
// USING THE OFFICIAL SDK FOR CHAT GENERATION
const getAIChatResponse = async (userQuery) => {
    ...
    try {
        // REWRITTEN FOR STRICT AQ. KEY FORMAT COMPATIBILITY
const getAIChatResponse = async (userQuery) => {
    if (!isApiKeyAvailable() || !aiModel) {
        appendChatMessage("The AI assistant is currently unavailable. Please try again later.", 'ai');
        return;
    ...
    try {
        // FIX: Wrap the request in an explicit contents array structural layout
        const result = await aiModel.generateContent({
            contents: [{ role: "user", parts: [{ text: prompt }] }]
        });
...
const validateApiKeyAndStart = async () => {
    ...
    try {
        ...
        // Initialize the client and the model
        const genAI = new GoogleGenerativeAI(GEMINI_API_KEY);
        aiModel = genAI.getGenerativeModel({ model: "gemini-2.5-flash" });
        // REMOVED THE countTokens TEST LINE HERE!
        
        // Go straight to loading the app
        initApp();
    } catch (error) {
        if(apiLoaderText) {
